...
export default defineUserConfig({
  ...
  lang: 'zh-CN',
  title: 'Olinl Note',
  description: 'Olinl Note 是一个基于 Vuepress 的个人笔记网站',

  head: [
    // 配置站点图标
    ['link', { rel: 'icon', type: 'image/png', href: 'https://q2.qlogo.cn/headimg_dl?dst_uin=9892214&spec=0' }],
  ],
  ...
  //   },
     ...
     */
    // cache: 'filesystem',//使用文件系统缓存,更适合内容多的项目使用
    cache:'memory',//使用内存缓存,适合文章数量较少的项目使用
